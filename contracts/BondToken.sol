...
contract BondToken is IBondToken, Ownable {
    ...
    constructor(string memory _tName, string memory _tSymbol, uint256 _tTotalSupply, address _owner){
        _name = _tName;
        _symbol = _tSymbol;

        _mint(_owner, _tTotalSupply);
    }
